                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .line_height(relative(1.7))
                                            .child(
                                                "Thundoku Shelf は、技術書典（TechBookFest）などのオンラインストアで購入した同人誌・技術書をデスクトップで管理・閲覧できるアプリです。購入履歴や書籍ファイルなどのデータはお使いの PC のローカルフォルダに保存されます（外部のサーバーには送りません。Google Drive バックアップを ON にしたときだけ、取り込んだ書籍ファイル本体と本棚の DB が Google Drive に保存されます）。",
                                            ),
                                    ),
                            ),
                    )
